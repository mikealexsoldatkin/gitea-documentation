...
如上所述下載主要的 Gitea 源程式碼。然後，派生 [Gitea 存放庫](https://github.com/go-gitea/gitea)，
並為您的本地存放庫切換 git 遠程源，或添加另一個遠程源：
...
為了能夠建立合併請求，應將分叉儲存庫添加為 Gitea 本地存放庫的遠程，否則無法推送更改。
...
並到[設定備忘單](../administration/config-cheat-sheet.md)
