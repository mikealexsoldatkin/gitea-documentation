...
- BaseRepoOwnerName：此合併請求的基礎存放庫所有者名稱
- BaseRepoName：此合併請求的基礎存放庫名稱
- BaseBranch：此合併請求的基礎存放庫目標分支名稱
- HeadRepoOwnerName：此合併請求的源存放庫所有者名稱
- HeadRepoName：此合併請求的源存放庫名稱
- HeadBranch：此合併請求的源存放庫分支名稱
